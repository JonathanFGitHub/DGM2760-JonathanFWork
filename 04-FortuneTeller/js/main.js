...
//Generates random integer using a value sent to it as the upper limit
...
const fortuneRevealed = `On ${monthName} ${day}, you will ${fortune}`; //concatenating a string - template literal
